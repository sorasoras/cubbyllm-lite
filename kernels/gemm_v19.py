"""v19: 256x128 block tiles (16 warps x 16 rows), KCW=4 chunks — the first
...
extern "C" __global__ void moe_v19(const uint32_t* __restrict__ Ap,
...
def compile_src(src, tag):
    ...
    fn = ctypes.c_void_p()
    assert HIP.hipModuleGetFunction(ctypes.byref(fn), m2, b"moe_v19") == 0
    return fn
