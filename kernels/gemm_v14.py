"""v14: sched-group-barrier forced batching — all 12 fragment loads in
...
extern "C" __global__ void moe_v14(const uint32_t* __restrict__ Ap,
...
def compile_src(src, tag):
    ...
    fn = ctypes.c_void_p()
    assert HIP.hipModuleGetFunction(ctypes.byref(fn), m2, b"moe_v14") == 0
    return fn
